...
export const LzPersonCA = Loadable({
  loader: () => import('./LzPersonCA'),
  loading() {
    return minLoading;
  }
});
...
export const LzStepsDOL = Loadable({
  loader: () => import('./LzStepsDOL'),
  loading() {
    return minLoading;
  }
});

export const LzStepsALL = Loadable({
  loader: () => import('./LzStepsALL'),
  loading() {
    return minLoading;
  }
});
