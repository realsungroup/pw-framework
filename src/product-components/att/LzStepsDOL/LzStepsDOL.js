 ...
 * 调休登记
 */
class LzStepsDOL extends React.Component {
  static propTypes = {
  ...
  renderSelectTime = current => {
    ...
    return (
      <div
        className={classNames('lz-steps-dol__2', {
          show: current === 1,
          hide: current !== 1
        })}
      >
...
export default Form.create()(LzStepsDOL);
