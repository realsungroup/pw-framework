 ...
 * 个人考勤
 */
export default class LzPersonCA extends React.Component {
  static propTypes = {
    /**
     * 用户记录
     */
    ...
    switch (this.state.selectedKey) {
      ...
      case '2': {
        tabsProps.tabPanes.forEach(item => {
          ...
          item.componentInfo.props.isSearch = true;
    ...
    return (
      <div className="lz-person-ca">
        <Layout style={{ width: '100%', height: '100%' }}>
          ...
          <Content>
            <div className="lz-person-ca__content">{this.renderContent(1)}</div>
          </Content>
        </Layout>
      </div>
    );
