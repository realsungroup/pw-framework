...
class IDLTransferVerifyAction extends Component {
  ...
  approve = async v => {
    ...
    try {
      ...
      this.setState({ conUnpass: false, visible: false, loading: false, buttonLoading: false });
    } catch (e) {
      console.log(e);
      this.setState({ loading: false, buttonLoading: false });
    }
              ...
              >
                {/* {this.state.loading ? null : (
                  <Steps
                    ...
                    status={
                      this.state.cms ==
                        `C3_634660565837 = 'N' and C3_634660565295 = '${this.state.userId}'`
                        ? 'error'
                        : this.state.cms ==
                          `C3_634660565837 = 'Y' and C3_634660565295 = '${this.state.userId}'`
                          ? 'process'
                          : 'process'
                    }
          ...
          <div className="sider">
            ...
            <p
              ...
              onClick={() => {
                this.setState({
                  selection: '2',
                  cms: `C3_634660565837 = 'Y' and C3_634660565295 = '${this.state.userId}'`
                });
              }}
            >
              已审批通过
            ...
            <p
              ...
              onClick={() => {
                this.setState({
                  selection: '3',
                  cms: `C3_634660565837 = 'N' and C3_634660565295 = '${this.state.userId}'`
                });
              }}
            >
              已审批未通过
