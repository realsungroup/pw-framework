                      ...
                      {this.state.step == 0 ? (
                        ...
                        >
                          ...
                          >
                            ...
                            <Spin spinning={this.state.loading}>
                              ...
                              >
                                <TableData
                                  resid={632327119162}
                                  cmswhere={this.state.companyV == '100' ? `C3_419339113187 != '' and C3_419448436728 = '菲尼萨光电通讯科技(无锡)有限公司'` : `C3_419339113187 != '' and C3_419448436728 = '菲尼萨光电通讯(上海)有限公司'`}
                                  hasRowView={false}
                                  subtractH={220}
                                  hasAdd={false}
                          ...
                          {/* <TreeSelect
                            ...
                            /> */}
                            <span>{this.state.depaV ? <><br />  {this.state.depaName} </> : ''}</span>
                            <Button style={{ marginLeft: 8 }} onClick={() => { this.setState({ showSelDep: true }) }}>选择部门</Button>
                            {this.state.depaV ? (
                              <>
                                <p
                                  style={{
