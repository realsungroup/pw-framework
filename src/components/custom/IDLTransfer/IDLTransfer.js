                          ...
                          actionBarExtra={({ dataSource, selectedRowKeys }) => {
                            return (
                              <Button
                                ...
                                onClick={() => {
                                  this.subDraft(dataSource, selectedRowKeys);
                                }}
                              >
                                提交
                              </Button>
                    ...
                    {this.state.depaV ? (
                      <>
                        ...
                        <Switch
                          ...
                          onChange={() =>
                            this.setState({ chooseFo: !this.state.chooseFo })
                          }
                        />
                        <span
                          style={{ textIndent: '8px', display: 'inline-block' }}
                        >
                          选择下属
                        </span>
                        <br />
                ...
                <Spin spinning={this.state.loading}>
                        ...
                        {this.state.selectMem.map((item, key) => {
                          return (
                            <li
                              key={key}
                              className={
                                this.state.curPeopleId == item.C3_448032387764
                                  ? 'current'
                                  : ''
                              }
                              onClick={(v, k) => {
                                this.selectSingle(item.C3_448032387764, key);
                              }}
                            >
                              <h4>{key + 1}</h4>
                              <p>
                  ...
                  <Select placeholder='请选择变更类型' style={{ width: 240 }} value={this.state.changeType} onChange={(v)=>{this.getBitian(v)}}>
                    ...
                    <Option value='职位变更' key='3'>职位变更</Option>
                      ...
                      >
                        {this.state.selectMem[this.state.curPeopleKey].newDepa
                          .C3_419339113187 ? (
                          this.state.selectMem[this.state.curPeopleKey].newDepa
                            .C3_419339113187
                        ) : (
                      ...
                      <Button
                        ...
                        onClick={() => this.setState({ searchDepaV: true })}
                      >
                        选择部门
                      </Button>
                      <div>
                      ...
                      <Input
                        ...
                        value={
                          this.state.selectMem[this.state.curPeopleKey].proCode
                        }
                      ...
                      <span style={{ width: 'auto' }}>
                        <Select
                          ...
                          style={{ width: 240 }}
                          value={
                            this.state.selectMem[this.state.curPeopleKey].lv
                          }
                          onChange={v => {
                            this.setValue(v, 'lv');
                          }}
                      ...
                      <b style={{ width: 'auto' }}>
                        (
                        {
                          this.state.selectMem[this.state.curPeopleKey].reason
                            .length
                        }
                        /500字)
                      </b>
                  ...
                  {this.state.result == 'success' ? (
                    <>
                      ...
                      <Button
                        style={{ marginRight: '16px', width: '120px' }}
                        onClick={() => {
                          this.setState({ step: 0, page: '2', isSub: false });
                        }}
                        type="primary"
                      >
                        查看审批记录
