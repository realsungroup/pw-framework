...
import './VisitorApplyVIPReceptionist.less';
...
class VisitorApplyVIPReceptionist extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      addModal: false,
  ...
  handleEdit = record => {
    ...
    this.setState({
      ...
      VIPCountCost: record.VIPCountCost,
      VIPfrontdeskRemark: record.VIPfrontdeskRemark
    });
  };
  componentDidMount = () => {
    this.getApprover();
  ...
  handleSave = async () => {
    ...
    console.log(this.state.record.REC_ID);
    try {
        ...
        data: [
          {
            ...
            VIPCountCost: this.state.VIPCountCost,
            VIPfrontdeskRemark: this.state.VIPfrontdeskRemark
          }
        ]
      });
    ...
    return (
      <React.Fragment>
        ...
        >
          <Form
            {...formItemLayout}
            className="VisitorApplyVIPReceptionist-form"
          >
            <div>
            ...
            <Form.Item label="VIP接待总费用">
              <Input
                onChange={v => {
                  this.setState({ VIPCountCost: v.target.value });
                }}
              />
            </Form.Item>
            <Form.Item label="VIP前台备注">
              <Input
                onChange={v => {
                  this.setState({ VIPfrontdeskRemark: v.target.value });
                }}
              />
            </Form.Item>
          </Form>
...
export default Form.create()(VisitorApplyVIPReceptionist);
