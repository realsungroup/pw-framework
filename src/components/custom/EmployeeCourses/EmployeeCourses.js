    ...
    return myCourses.map(item => (
      ...
      >
        <div className="emploee_courses-main-course_content">
          <div className="course_item">讲师:<span style={{paddingLeft:12}}>{item.C3_613941386081}</span></div>
          <div className="course_item">人数:<span style={{paddingLeft:12}}>{item.C3_613941386325}</span></div>
          <div className="course_item">地点:<span style={{paddingLeft:12}}>{item.C3_613941386325}</span></div>
          <div className="course_item">时间:<span style={{paddingLeft:12}}>{item.courseTime}</span></div>
        </div>
            ...
            >
              ...
              <div style={{ width: '30%', padding: '0 12px' }}>
                {selectedCourse.courseType === '外训' ? (
                  <Timeline>
                    <Timeline.Item color="green">计划提交{selectedCourse.C3_615392983685}</Timeline.Item>
                    <Timeline.Item color="green">计划审批{selectedCourse.C3_615394023182}</Timeline.Item>
                    <Timeline.Item>              申请单提交{selectedCourse.C3_615377538264}</Timeline.Item>
                    <Timeline.Item color="#aaa"> 申请单审批{selectedCourse.C3_615377747279}</Timeline.Item>
                    <Timeline.Item color="#aaa"> 上课开始{selectedCourse.C3_615393041304}</Timeline.Item>
                    <Timeline.Item color="#aaa"> 上课结束{selectedCourse.C3_615393093633}</Timeline.Item>
                    <Timeline.Item color="#aaa"> 课程反馈{selectedCourse.C3_615377481222 }</Timeline.Item>
