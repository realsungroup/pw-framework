        ...
        >
          <div className='wrap'>
            ...
            <Input
              ...
              onChange={v => {
                this.setState({ C3_629487955668: v.target.value });
              }}
            />
            ...
            <Input
              ...
              onChange={v => {
                this.setState({ C3_629488075916: v.target.value });
              }}
            />
            <div className="clearfix"> </div>
            <span>面试时间：</span>
            ...
            <Input
              ...
              onChange={v => {
                this.setState({ C3_629910106446: v.target.value });
              }}
            />
            <div className="clearfix"> </div>
            <span>联系人：</span>
            <Input
              ...
              onChange={v => {
                this.setState({ C3_629488005816: v.target.value });
              }}
            />
            <div className="clearfix"> </div>
            <span>联系电话：</span>
            <Input
              ...
              onChange={v => {
                this.setState({ C3_629488028156: v.target.value });
              }}
            />
            <div className="clearfix"> </div>
            {/* <span>招聘负责人：</span>
        ...
        <div style={{ height: '100vh' }}>
          <TableData
            ...
            customRowBtns={[
              ...
              record => {
                return record.C3_629488387048 != 'Y' ? (
                  <Button
                    onClick={() => {
