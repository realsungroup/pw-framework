     ...
     <div className={this.state.edit?'PersonInfoInFile':'PersonInfoInFile PersonInfoInFileForbid'} id='toPrint'>
       ...
       style={{marginTop:'16px',marginBottom:'16px'}}>专业/执业资格：</div>
          ...
          <th style={{height:'24px',lineHeight:'24px',fontWeight:'bold',textIndent:'16px'}}>名称</th>
            ...
            <th style={{height:'24px',lineHeight:'24px',fontWeight:'bold',textIndent:'16px'}}>颁发机构</th>
            <th style={{height:'24px',lineHeight:'24px',fontWeight:'bold',textIndent:'16px'}}>获得日期</th>
          </tr>
          <tr>
            <td style={{height:'24px',lineHeight:'24px' }}>
        ...
        style={{marginTop:'16px',marginBottom:'16px'}}>三、工作经验（请务必填写完整工作经历）</h4>
          ...
          <th style={{height:'24px',lineHeight:'24px',fontWeight:'bold',textIndent:'16px' }}>开始日期</th>
            <th style={{height:'24px',lineHeight:'24px',fontWeight:'bold',textIndent:'16px' }}>结束日期</th>
            <th style={{height:'24px',lineHeight:'24px',fontWeight:'bold',textIndent:'16px' }}>公司名称</th>
            <th style={{height:'24px',lineHeight:'24px',fontWeight:'bold',textIndent:'16px' }}>职位</th>
            <th style={{height:'24px',lineHeight:'24px',fontWeight:'bold',textIndent:'16px' }}>离职原因</th>
          </tr>
          <tr>
            <td style={{height:'24px',lineHeight:'24px' }}>
        ...
        <div className='page' style={{
         ...
         boxSizing:'border-box',
          ...
          <th style={{height:'24px',lineHeight:'24px',fontWeight:'bold',textIndent:'16px' }}>姓名</th>
            ...
            <th style={{height:'24px',lineHeight:'24px',fontWeight:'bold',textIndent:'16px' }}>工作单位</th>
          </tr>
          <tr>
            <td style={{height:'24px',lineHeight:'24px' }}>
        ...
        <div style={{marginTop:'16px',marginBottom:'16px'}}>2.紧急联系人</div>
          ...
          <td style={{height:'24px',lineHeight:'24px' }}><Input disabled={!this.state.edit}size='small' style={{width:'100%'}}/></td>
            <td style={{height:'24px',lineHeight:'24px' }}><Input disabled={!this.state.edit}size='small' style={{width:'100%'}}/></td>
            <td style={{height:'24px',lineHeight:'24px' }}><InputNumber disabled={!this.state.edit} size='small' style={{width:'100%'}}/></td>
            <td style={{height:'24px',lineHeight:'24px' }}><Input disabled={!this.state.edit}size='small' style={{width:'100%'}}/></td>
            <td style={{height:'24px',lineHeight:'24px' }}><InputNumber disabled={!this.state.edit} size='small' style={{width:'100%'}}/></td>
            <td style={{height:'24px',lineHeight:'24px' }}><Input disabled={!this.state.edit}size='small' style={{width:'100%'}}/></td>
          </tr>
