...
class ChartCommunication extends React.Component {
  ...
  getData = async (stTime, edTime) => {
    ...
    try {
      ...
      res.cmscolumninfo
        .find(item => item.id === 'typeComplaint')
        .typeComplaint.DisplayOptions.filter(item => item)
        .forEach(item => {
          complainTypeData[item] = {
            brid: item,
            count: 0,
            pending: 0,
            processing: 0,
      ...
      res.cmscolumninfo
        .find(item => item.id === 'typeAdvice')
        .typeAdvice.DisplayOptions.filter(item => item)
        .forEach(item => {
  ...
  exportPNG = async () => {
    ...
    await html2canvas(document.querySelector('.toPrint')).then(canvas => {
                ...
                <div ref="toPrint" className="toPrint">
                  ...
                  <Spin spinning={this.state.loading}>
                    <div>
                      ...
                      ></i>
                      <span>APP：{this.state.app}次</span>
                      <i
                        style={{
                          display: 'inline-block',
                          width: '0.8rem',
                      ...
                      ></i>
                      <span>线下：{this.state.offline}次</span>
                    </div>
                    <div
                      style={{
                        marginTop: '0.5rem',
                        ...
                        height: '0.8rem',
                        overflow: 'hidden',
                        background: this.state.total == 0 ? '#f5f5f5' : '#fff'
                      }}
                    >
                      <div
                        style={{
                          ...
                          width:
                            this.state.total == 0
                              ? 0
                              : (this.state.app / this.state.total) * 100 + '%'
                        }}
                      ></div>
                      <div
                        style={{
                          ...
                          width:
                            this.state.total == 0
                              ? 0
                              : (this.state.offline / this.state.total) * 100 +
                                '%'
                        }}
                      ></div>
                    </div>
                    <div style={{ marginTop: 16 }}>
                      ...
                      ></i>
                      <span>投诉：{this.state.tousu}次</span>
                      <i
                        style={{
                          display: 'inline-block',
                          width: '0.8rem',
                      ...
                      ></i>
                      <span>求助/申诉：{this.state.qiuzhu}次</span>
                      <i
                        style={{
                          display: 'inline-block',
                          width: '0.8rem',
                      ...
                      ></i>
                      <span>合理化建议：{this.state.jianyi}次</span>
                    </div>
                    <div
                      style={{
                        marginTop: '0.5rem',
                      ...
                      <div
                        style={{
                          ...
                          width:
                            this.state.total == 0
                              ? 0
                              : (this.state.tousu / this.state.total) * 100 +
                                '%'
                        }}
                      ></div>
                      <div
                        style={{
                          ...
                          width:
                            this.state.total == 0
                              ? 0
                              : (this.state.qiuzhu / this.state.total) * 100 +
                                '%'
                        }}
                      ></div>
                      <div
                        style={{
                          ...
                          width:
                            this.state.total == 0
                              ? 0
                              : (this.state.jianyi / this.state.total) * 100 +
                                '%'
                        }}
                      ></div>
                    </div>
                    <div style={{ overflow: 'hidden', marginTop: '24px' }}>
                      ...
                      <p style={{ width: '88px', float: 'left' }}>投诉：</p>
                      <div
                        style={{
                          float: 'left',
                          width: 304,
                          height: '0.8rem',
                          marginTop: '0.1rem',
                          background: this.state.replyTousu ? '#fff' : '#f5f5f5'
                        }}
                      >
                        <div
                          style={{
                            ...
                            width:
                              this.state.maxTime == 0
                                ? 0
                                : (this.state.replyTousu / this.state.maxTime) *
                                    100 +
                                  '%'
                          }}
                        ></div>
                      ...
                      <p style={{ float: 'right' }}>
                        {parseInt(this.state.replyTousu / 3600)}时
                        {parseInt((this.state.replyTousu % 3600) / 60)}分
                        {parseInt(this.state.replyTousu % 60)}秒
                      </p>
                      <div style={{ clear: 'both' }}></div>
                      <p style={{ width: '88px', float: 'left' }}>
                        求助/申诉：
                      </p>
                      <div
                        style={{
                          ...
                          height: '0.8rem',
                          marginTop: '0.1rem',
                          background: this.state.replyQiuzhu
                            ? '#fff'
                            : '#f5f5f5'
                        }}
                      >
                      ...
                      <p style={{ float: 'right' }}>
                        {parseInt(this.state.replyQiuzhu / 3600)}时
                        {parseInt((this.state.replyQiuzhu % 3600) / 60)}分
                        {parseInt(this.state.replyQiuzhu % 60)}秒
                      </p>
                      <div style={{ clear: 'both' }}></div>
                      <p style={{ width: '88px', float: 'left' }}>
                        合理化建议：
                      ...
                      <div
                        style={{
                          ...
                          height: '0.8rem',
                          marginTop: '0.1rem',
                          background: this.state.replyJianyi
                            ? '#fff'
                            : '#f5f5f5'
                        }}
                      >
                      ...
                      <p style={{ float: 'right' }}>
                        {parseInt(this.state.replyJianyi / 3600)}时
                        {parseInt((this.state.replyJianyi % 3600) / 60)}分
                        {parseInt(this.state.replyJianyi % 60)}秒
                      </p>
                      <div style={{ clear: 'both' }}></div>
                    </div>
                    ...
                    <div style={{ overflow: 'hidden', marginTop: '24px' }}>
                      ...
                      <div
                        style={{
                          ...
                          height: '0.8rem',
                          marginTop: '0.1rem',
                          background: this.state.replyTousuAvg
                            ? '#fff'
                            : '#f5f5f5'
                        }}
                      >
                        <div
                          style={{
                            ...
                            background: '#1890ff',
                            width:
                              this.state.maxTimeAvg == 0
                                ? 0
                                : (this.state.replyTousuAvg /
                                    this.state.maxTimeAvg) *
                                    100 +
                                  '%'
                          }}
                        ></div>
                      ...
                      <p style={{ float: 'right' }}>
                        {parseInt(this.state.replyTousuAvg / 3600)}时
                        {parseInt((this.state.replyTousuAvg % 3600) / 60)}分
                        {parseInt(this.state.replyTousuAvg % 60)}秒
                      </p>
                      <div style={{ clear: 'both' }}></div>
                      <p style={{ width: '88px', float: 'left' }}>
                        求助/申诉：
                      ...
                      <div
                        style={{
                          ...
                          height: '0.8rem',
                          marginTop: '0.1rem',
                          background: this.state.replyQiuzhuAvg
                            ? '#fff'
                            : '#f5f5f5'
                        }}
                      >
                      ...
                      <p style={{ float: 'right' }}>
                        {parseInt(this.state.replyQiuzhuAvg / 3600)}时
                        {parseInt((this.state.replyQiuzhuAvg % 3600) / 60)}分
                        {parseInt(this.state.replyQiuzhuAvg % 60)}秒
                      </p>
                      <div style={{ clear: 'both' }}></div>
                      <p style={{ width: '88px', float: 'left' }}>
                        合理化建议：
                      ...
                      <div
                        style={{
                          ...
                          height: '0.8rem',
                          marginTop: '0.1rem',
                          background: this.state.replyJianyiAvg
                            ? '#fff'
                            : '#f5f5f5'
                        }}
                      >
                      ...
                      <p style={{ float: 'right' }}>
                        {parseInt(this.state.replyJianyiAvg / 3600)}时
                        {parseInt((this.state.replyJianyiAvg % 3600) / 60)}分
                        {parseInt(this.state.replyJianyiAvg % 60)}秒
                      </p>
                      <div style={{ clear: 'both' }}></div>
                    </div>

                    <div style={{ overflow: 'hidden', marginTop: '24px' }}>
                      <p style={{ width: '88px', fontWeight: 'bold' }}>
                        处理状态：
                      </p>
                      <div style={{ marginTop: 16 }}>
                        <span>投诉：</span>
                        ...
                        ></i>
                        <span>未处理：{this.state.waitTousu}次</span>
                        <i
                          style={{
                            display: 'inline-block',
                            width: '0.8rem',
                        ...
                        ></i>
                        <span>处理中：{this.state.ingTousu}次</span>
                        <i
                          style={{
                            display: 'inline-block',
                            width: '0.8rem',
                        ...
                        ></i>
                        <span>已处理：{this.state.tousuCount}次</span>
                      </div>
                      <div
                        style={{
                          width: 545,
                          ...
                          marginTop: '0.5rem',
                          overflow: 'hidden',
                          background: this.state.tousu == 0 ? '#f5f5f5' : '#fff'
                        }}
                      >
                        <div
                          style={{
                            ...
                            width:
                              this.state.tousu == 0
                                ? 0
                                : (this.state.waitTousu / this.state.tousu) *
                                    100 +
                                  '%'
                          }}
                        ></div>
                        <div
                          style={{
                            ...
                            width:
                              this.state.tousu == 0
                                ? 0
                                : (this.state.ingTousu / this.state.tousu) *
                                    100 +
                                  '%'
                          }}
                        ></div>
                        <div
                          style={{
                            ...
                            width:
                              this.state.tousu == 0
                                ? 0
                                : (this.state.tousuCount / this.state.tousu) *
                                    100 +
                                  '%'
                          }}
                        ></div>
                      ...
                      <div style={{ marginTop: '.5rem' }}>
                        ...
                        ></i>
                        <span>未处理：{this.state.waitQiuzhu}次</span>
                        <i
                          style={{
                            display: 'inline-block',
                            width: '0.8rem',
                        ...
                        ></i>
                        <span>处理中：{this.state.ingQiuzhu}次</span>
                        <i
                          style={{
                            display: 'inline-block',
                            width: '0.8rem',
                        ...
                        ></i>
                        <span>已处理：{this.state.qiuzhuCount}次</span>
                      </div>
                      <div
                        style={{
                          marginTop: '.5rem',
                          ...
                          overflow: 'hidden',
                          background:
                            this.state.qiuzhu == 0 ? '#f5f5f5' : '#fff'
                        }}
                      >
                        <div
                          style={{
                            ...
                            width:
                              this.state.qiuzhu == 0
                                ? 0
                                : (this.state.waitQiuzhu / this.state.qiuzhu) *
                                    100 +
                                  '%'
                          }}
                        ></div>
                        <div
                          style={{
                            ...
                            width:
                              this.state.qiuzhu == 0
                                ? 0
                                : (this.state.ingQiuzhu / this.state.qiuzhu) *
                                    100 +
                                  '%'
                          }}
                        ></div>
                        <div
                          style={{
                            ...
                            width:
                              this.state.qiuzhu == 0
                                ? 0
                                : (this.state.qiuzhuCount / this.state.qiuzhu) *
                                    100 +
                                  '%'
                          }}
                        ></div>
                      ...
                      <div style={{ marginTop: 16 }}>
                        ...
                        ></i>
                        <span>未处理：{this.state.waitJianyi}次</span>
                        <i
                          style={{
                            display: 'inline-block',
                            width: '0.8rem',
                        ...
                        ></i>
                        <span>处理中：{this.state.ingJianyi}次</span>
                        <i
                          style={{
                            display: 'inline-block',
                            width: '0.8rem',
                        ...
                        ></i>
                        <span>已处理：{this.state.jianyiCount}次</span>
                      </div>
                      <div
                        style={{
                          marginTop: 16,
                          ...
                          overflow: 'hidden',
                          background:
                            this.state.jianyi == 0 ? '#f5f5f5' : '#fff'
                        }}
                      >
                        <div
                          style={{
                            ...
                            width:
                              this.state.jianyi == 0
                                ? 0
                                : (this.state.waitJianyi / this.state.jianyi) *
                                    100 +
                                  '%'
                          }}
                        ></div>
                        <div
                          style={{
                            ...
                            width:
                              this.state.jianyi == 0
                                ? 0
                                : (this.state.ingJianyi / this.state.jianyi) *
                                    100 +
                                  '%'
                          }}
                        ></div>
                        <div
                          style={{
                            ...
                            width:
                              this.state.jianyi == 0
                                ? 0
                                : (this.state.jianyiCount / this.state.jianyi) *
                                    100 +
                                  '%'
                          }}
                        ></div>
                    ...
                    <div style={{ overflow: 'hidden', marginTop: '24px' }}>
                      ...
                      <div
                        id="mycharts"
                        style={{ width: '571px', height: '264px' }}
                      ></div>
                    </div>
                    <div style={{ overflow: 'hidden', marginTop: '24px' }}>
          ...
          <TabPane tab="自定义" key="2">
            <div className="searchBar">
              ...
              <RangePicker
                ...
                allowClear={false}
                onChange={v => {
                  let cms = `time >= '${moment(v[0]).format(
                    'YYYY-MM-DD'
                  )}' and time <= '${moment(v[1]).format('YYYY-MM-DD')}'`;
                  this.setState({ customDate: v, customCms: cms });
                  this.calCms(
                    cms,
                    this.state.customCms2,
                    this.state.customCms3
                  );
                }}
              />
              ...
              <RangePicker
                ...
                onChange={v => {
                  let cms = `HRReplyTime >= '${moment(v[0]).format(
                    'YYYY-MM-DD HH:mm:ss'
                  )}' and HRReplyTime <= '${moment(v[1]).format(
                    'YYYY-MM-DD HH:mm:ss'
                  )}'`;
              ...
              <RangePicker
                ...
                onChange={v => {
                  let cms = `addDate >= '${moment(v[0]).format(
                    'YYYY-MM-DD HH:mm:ss'
                  )}' and HRReplyTime <= '${moment(v[1]).format(
                    'YYYY-MM-DD HH:mm:ss'
                  )}'`;
