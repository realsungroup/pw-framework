  ...
  render() {
    return (
      ...
      <Spin spinning={this.state.loading}>
        ...
        <div className={(this.state.data.location=="WX")||(!this.state.data.location)?'offer-content':'hidden'}>
          ...
          <ul>
            ...
            <li className={(this.state.data.isHasStock=='Y')?'':'hidden'}>
              ...
              {this.state.isShow ? (
                ...
                <span>{this.state.data.salary}</span>
              )}.  The value will be split equally (50/50) between Stock Options and RSUs.  The price associated with these RSUs and Stock Options will be referenced from the closing price on the 27th day of the month following the next II-VI Board of Director’s Meeting and will be awarded on the 28th of that month, upon approval.  The Restricted Stock Units vest equally over a three-year period at the rate of one third per year.  The Stock Options vest equally over a four-year period at a rate of one quarter per year.  These Awards will be subject to the terms and conditions of II-VI’s Stock Incentive Plan and applicable agreements.
              <br/><br/>
          ...
          <p style={{ paddingBottom: '5px' }}>
            ...
            <br />
            <br />
          VP of HR and Administration for Asia and Photonic Solutions
            <br />
          </p>
          ...
          <div className={(this.state.data.location=="SH")?'offer-content':'hidden'}>
            <div style={{ textAlign: 'center' }}>
              <div className="logo ">
                <img src={logo} />
              </div>
              <div className="header">
                ...
                <p style={{ margin: '0' }}>
                66 Huiqing Rd., Zhangjiang Hi-Tech Park<br/>Pudong Shanghai, China 201201<br/>Main: +86-21-38559200 Fax: +86-21-68919894
                </p>
                <h3>JOB OFFER LETTER</h3>
              </div>
            </div>
            ...
            <p>
              Should you accept this job offer, per company policy you will be eligible to receive the following compensations or arrangement beginning on your reporting date.
            </p>
            <ul>
              <li>
                <strong>Salary</strong>:  Monthly gross starting salary of{' '}
              ...
              <li className={(this.state.data.isHasStock=='Y')?'':'hidden'}>
                ...
                {this.state.isShow ? (
                  ...
                  <span>{this.state.data.salary}</span>
                )} in Finisar’s Restricted Stock Units (RSUs). These RSUs will vest over a four-year period at the rate of 25% per year starting from the date of grant and will be subject to the terms and conditions of Finisar’s Stock Incentive Plan and applicable agreements. 
                <br/><br/>
                If you start after the acquisition date, you will be issued a combination of II-VI Stock Options and RSUs with the same or slightly greater value than the value referenced above. The value will be split equally (50/50) between Stock Options and RSUs. The price associated with these RSUs and Stock Options will be referenced from the closing price on the 27th day of the month following the next II-VI Board of Director’s Meeting and will be awarded on the 28th of that month, upon approval. The Restricted Stock Units vest equally over a three-year period at the rate of one third per year. The Stock Options vest equally over a four-year period at a rate of one quarter per year.  These Awards will be subject to the terms and conditions of II-VI’s Stock Incentive Plan and applicable agreements. 
                <br/><br/>
                If the employment contract between you and the company is terminated, all offered RSUs/Stock Options that have not vested will be cancelled unconditionally and immediately on your last working day.
                <br />
                <br />
              </li>
              <li>
                <strong>Yearly Bonus:</strong> Equal to 1 month of your base salary. Will be paid pro rata according to the service months in the calendar year. If the employment contract between you and company end before the payment date, you will not eligible for this bonus.
              </li>
              <li>
                <strong>Level:</strong>{' '}
                <strong>
              ...
              <ul>
                <p>
                  Standard, Finisar Shanghai, Inc. provided benefits for salaried-exempt employees, including the following.
                </p>
                <li>
                  Social insurance and housing fund as required by the local municipal government of Shanghai.
                </li>
                <li>
                  Other benefits in accordance with company policy and government regulations.
                </li>
              </ul>
            </ul>
            <p style={{ paddingBottom: '5px' }}>
            ...
            <p>
              ...
              at Finisar Shanghai, Incorporated. I have reviewed and agree the following hiring and on-board conditions.
              <br />
              <br />
              <p style={{ margin: '0' }}>
                Signature:{' '}
            ...
            <div style={{ marginBottom: '40px' }}>
              <ul className="notice" style={{ paddingLeft: '0px' }}>
                ...
                <li>6. 体检报告:<br/>注：已居住在上海的员工必须到美年健康做标准体检（菲尼萨团体体检为160元/男或者175元/女套餐），体检预约电话：4006808855；如有最近三个月以内三甲医院的体检报告，可直接携带该报告入职，无需另外再做入职体检；如本人不在上海，可在当地三甲医院做常规入职体检，费用在200元左右。</li>
                <li>7.劳动手册（上海市户口）；</li>
                <li>
                  8.
                  公积金事宜：如您已缴纳公积金，请通知您所在的公司将公积金转移至881546569205（补充公积金转移至      209881546560）, 帐号名称：菲尼萨光电通讯（上海）有限公司；或者将公积金帐号封存后提供给菲尼萨人力资源部。
                </li>
              </ul>
            </div>
        ...
        >
          ...
          <Button
            style={{ marginLeft: '5px' }}
            onClick={this.showHis}
          >
            查看邮件记录
          </Button>
          <span style={{marginLeft:'8px',color:'red'}}className={this.state.data.isSendEmail=="Y"?'':'hidden'}>已发送过邮件</span>
        </div>
