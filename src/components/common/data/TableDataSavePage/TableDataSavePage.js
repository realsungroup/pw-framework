 ...
 * TableData
 */
class TableDataSavePage extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    var pageSize = Number(sessionStorage.getItem("currentPageSize"));
    
    await this.getData({},page,pageSize);
  ...
  handlePageChange = async (page, pageSize) => {
    ...
    window.sessionStorage.setItem("currentPageSize", pageSize);
...
export default composedHoc(TableDataSavePage);
