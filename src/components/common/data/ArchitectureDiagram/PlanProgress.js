  ...
  componentDidMount = async () => {
    ...
    try {
      switch (this.props.struct) {
        case '100':
          res = await http(httpParams).StartSaveTask(this.props.options);
          break;
        case '200':
          res = await http(httpParams).StartSaveTask200(this.props.options);
          break;
        default:
          res = await http(httpParams).StartSaveTask(this.props.options);
          break;
          ...
          <List
            ...
            renderItem={item => (
              <List.Item>
                ...
                >
                  <div style={{ flex: 1 }}>
                    {this.props.showFields && item[this.props.showFields[0]]}
                  </div>
                  <div style={{ flex: 1 }}>
                    {this.props.showFields && item[this.props.showFields[1]]}
                  </div>
                  {/* <Tag
                  style={{
                    flex: 1,
