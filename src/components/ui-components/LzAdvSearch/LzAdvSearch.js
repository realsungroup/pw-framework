...
export default class LzAdvSearch extends React.Component {
  ...
  getWhetherConfig = () => {
    ...
    this.whetherConfig = cloneDeep(whether);
    return cloneDeep(whether);
  };
  ...
  getSearchConfig = () => {
    ...
    this.searchConfig = cloneDeep(search);
  ...
  getDateRanges = () => {
    ...
    const dateRanges = cloneDeep(this.props.advSearchConfig.dateRanges);
    dateRanges.forEach(item => {
      const newDateInfo = cloneDeep(dateInfo);
    ...
    this.dateRanges = cloneDeep(dateRanges);
    return dateRanges;
  };
  ...
  reset = () => {
    this.setState({
      dateRanges: cloneDeep(this.dateRanges),
      tagsConfig: cloneDeep(this.tagsConfig),
      searchConfig: cloneDeep(this.searchConfig),
      whetherConfig: cloneDeep(this.whetherConfig)
    });
    this.wheres = [[], [], [], []];
    this.retCmsWhere();
  };
