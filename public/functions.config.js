...
window[590765309983] = {
  ...
  props: {
    // jump:
    //   'http://test.ehr.web.realsun.biz5/fnmodule?resid=590765309983&recid=610540465303&type=undefined&title=违纪管理',
...
window[641990842014] = {
  ...
  props: {
    resid: '534530373089',
    replaceBaseUrl: 'http://test.ehr.web.realsun.biz11/',
    baseURL: 'http://test.pwk.web.api.realsun.biz'
  }
};
window[641992029202] = {
...
window[641992200325] = {
  ...
  props: {
    resid: '578227119902',
    replaceBaseUrl: 'http://test.ehr.web.realsun.biz19'
  }
};
//总部-offer
window[641992279531] = {
...
window[642858615601] = {
  ...
  props: {
    gradeAppraisingConfig: {
      resid: 645010935966,
      replaceBaseUrl: 'http://test.ehr.web.realsun.biz/',
      baseURL: 'http://test.ehr.web.api.realsun.biz/'
    },
    residConfig: {
      年中目标: 462637854501,
...
window[645287046055] = {
  ...
  title: '绩效评级评优', // 功能模块名称
  props: {
    tableDataBaseURL: 'http://test.pwk.web.api.realsun.biz/',
    mangerConfig: {
      '12345': {
        //总经理
        id: 12345,
        ...
        baseURL: 'http://test.ehr.web.api.realsun.biz/',
        downloadBaseURL: 'http://test.pwk.web.api.realsun.biz/'
      },
      '169': {
        //总监
        id: 169,
...
window[733239312667] = {//后台资源id
  ...
  props: {
    ...
    baseURL: 'http://test.pwk.web.api.realsun.biz',//请求后台地址
    SSO: 1
  }
};
