...
window[641990842014] = {
  ...
  props: {
    resid: '534530373089',
    replaceBaseUrl: 'http://ngrok16.realsun.me:7071',
...
window[642858615601] = {
  ...
  props: {
    gradeAppraisingConfig: {
      resid: 645010935966,
      replaceBaseUrl: 'http://ngrok11.realsun.me:7071/',
      baseURL: 'http://ngrok14.realsun.me:7071/'
    },
    residConfig: {
      年中目标: 462637854501,
...
window[645287046055] = {
  ...
  title: '绩效评级评优', // 功能模块名称
  props: {
    tableDataBaseURL:'http://ngrok4.realsun.me:7071/',
    mangerConfig: {
      '12345': {
        //总经理
        id: 12345,
        ...
        replaceBaseUrl: 'http://ngrok9.realsun.me:7071',
        baseURL: 'http://ngrok14.realsun.me:7071/',
        downloadBaseURL:'http://ngrok12.realsun.me:7071/',
      },
      '169': {
        //总监
        id: 169,
...
window[647005718255] = {
  ...
  props: {
    ...
    mainTableProps: {
      ...
      baseURL: 'http://ngrok14.realsun.me:7071/',
      downloadBaseURL: 'http://ngrok13.realsun.me:7071/',
      mediaFieldBaseURL: 'http://ngrok13.realsun.me:7071/',
      formProps: {
        // height: 500
      },
      backendButtonPopConfirmProps:{ placement: 'bottom' },
