...
window.pwConfig = {
  ...
  development: {
    ...
    baseURL: 'http://demo.pwk.web.api.realsun.me/', // 请求的基地址
    // baseURL: 'http://demo.pwk.web.api.realsun.me/', // 请求的基地址
    basename: '/',
    ...
    fileDownloadUrl: 'http://demo.pwk.web.realsun.me/', // 导出 Excel 文件下载基地址
    ...
    // 切换考勤月份的基地址
    attendanceMonthChangeUrl: 'http://demo.ehr.web.api.realsun.me/',
    fileDownloadConfig: {
      629462405981: {
        fileType: 'mdb'
      }
    ...
    customURLs: {
      ...
      PostArchitectureBaseURL: 'http://demo.ehr.web.api.realsun.me/',
    ...
    domainLoginConfig: {
      // 预登录配置
      baseUrl: 'http://demo.pwk.web.api.realsun.me/', // 域登录基地址
  ...
  production: {
    ...
    customURLs: {
      ...
      HeadCountBaseURL: 'http://demo.ehr.web.api.realsun.me/',
      PostArchitectureBaseURL: 'http://demo.ehr.web.api.realsun.me/',
      comprehensiveQueryBaseURL: 'http://demo.ehr.web.api.realsun.me/', //综合查询
      dlEmployBaseURL: 'http://kingofdinner.realsun.me:1201/', //DL招聘-DL管理员
      dlEmployDownloadURL: 'http://kingofdinner.realsun.me:1200/', //DL招聘-DL管理员下载URl
